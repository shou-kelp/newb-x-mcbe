...
/* Torch colors */
#define NL_OVERWORLD_TORCH_COL  vec3(1.00, 0.45, 0.40)
#define NL_UNDERWATER_TORCH_COL vec3(0.04, 0.70, 0.31)
#define NL_NETHER_TORCH_COL     vec3(2.25, 1.64, 1.15)
#define NL_END_TORCH_COL        vec3(0.88, 0.40, 1.20)

/* Fog */
#define NL_FOG                  1.0     // [toggle] 0.1 subtle ~ 1.0 blend with sky completely
#define NL_MIST_DENSITY         0.99    // 0.0 no mist ~ 1.0 misty
...
#define NL_WATER_TINT           vec3(0.65, 1.00, 0.95)
...
#define NL_CLOUD2_SHAPE             vec2(0.5, 0.55)     // 0.0 round ~ 1.0 box vec2(horizontal shape, vertical shape)
...
#define NL_CLOUD2_LAYER2_THICKNESS          2.3     // 0.7 slim ~ 5.0 fat
#define NL_CLOUD2_LAYER2_RAIN_THICKNESS     2.6     // 0.7 slim ~ 5.0 fat
...
#define NL_CLOUD2_LAYER2_SHAPE              vec2(0.5, 0.55)     // 0.0 round ~ 1.0 box vec2(horizontal shape, vertical shape)
#define NL_CLOUD2_LAYER2_DENSITY            80.0    // 1.0 blurry ~ 100.0 sharp
...
#define NLC_SUN_BLOOM       0.05     // 0.1 dim - 2.0 bright 
#define NLC_MOON_BLOOM      0.5     // 0.1 dim - 2.0 bright
#define NLC_SUN_BLOOM_COL   vec3(0.75, 0.25, 0.00)
#define NLC_MOON_BLOOM_COL  vec3(0.75, 0.75, 0.75)
...
#define NLC_END_GALAXY_STARS        1.6     // [toggle] 0.1 dim - 4.0 bright
